This page hosts summaries of EPA data related to air pollution, [water pollution](https://ejsff.github.io/FERTH2O/) and GHG emissions from fertilizer plants and other facilities along with environmental justice demographic data from EPA's EJSCREEN tool.


# WATER POLLUTION
See [HERE](https://ejsff.github.io/FERTH2O/) for a summary of N water pollution from fertilizer manufacturing based on data from EPA's ECHO database.
